---
layout: page
permalink: /compliance/fda-medical-device/
...
- [Schema Crosswalk]({{ site.url }}/compliance/schema-crosswalk/) - Field mappings for lifecycle properties
- [CLE (Common Lifecycle Enumeration)]({{ site.url }}/compliance/cle/) - Standard for machine-readable lifecycle events

## Related Frameworks

- [NTIA Minimum Elements]({{ site.url }}/compliance/ntia-minimum-elements/) - Baseline attributes referenced by FDA
- [CISA Framing Document]({{ site.url }}/compliance/cisa-framing/) - Source of baseline attribute definitions

## Additional Resources

For more details, see our [FDA Medical Device SBOM Requirements guide]({{ site.url }}/blog/fda-medical-device-sbom-requirements/).
