...
This release ships with five compliance plugins ready to use. Each plugin aligns with our [compliance documentation]({{ site.url }}/compliance/), so you can understand exactly what is being validated:

- **[NTIA Minimum Elements]({{ site.url }}/compliance/ntia-minimum-elements/)** - Validates your SBOMs against the foundational US baseline for SBOM data fields
- **[CISA 2025 Minimum Elements]({{ site.url }}/compliance/cisa-minimum-elements/)** - Checks compliance with the updated US guidance including hash, license, and generation context
- **[EU Cyber Resilience Act (CRA)]({{ site.url }}/compliance/eu-cra/)** - Validates against Regulation 2024/2847 requirements (beta)
- **[FDA Medical Device Cybersecurity]({{ site.url }}/compliance/fda-medical-device/)** - Ensures medical device SBOM requirements are met, including lifecycle properties
