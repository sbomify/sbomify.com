...
A [Software Bill of Materials]({{ site.url }}/what-is-sbom/) plays a critical role in license compliance by documenting every component in your software along with its license. This is essential for GPL compliance because:

1. **Identifying GPL components.** SBOMs include license information for each component, making it straightforward to determine whether your project includes any GPL-licensed dependencies. The [CISA minimum elements draft]({{ site.url }}/compliance/cisa-minimum-elements/) now includes license as a recommended SBOM field.
