...
For a complete field-by-field mapping, see our [SBOM Schema Crosswalk]({{ site.url }}/compliance/schema-crosswalk/).
...
| --------------------------------------------------------------------------------- | ---------------------------------------------------------- |
| [Executive Order 14028]({{ site.url }}/compliance/eo-14028/) (US)                 | Format-agnostic; both accepted                             |
| [CISA Minimum Elements]({{ site.url }}/compliance/cisa-minimum-elements/)         | Format-agnostic; references both                           |
| [EU Cyber Resilience Act]({{ site.url }}/compliance/eu-cra/) (via BSI TR-03183-2) | CycloneDX 1.6+ or SPDX 3.0.1+, JSON or XML format required |
| [NTIA Minimum Elements]({{ site.url }}/compliance/ntia-minimum-elements/)         | Format-agnostic; both satisfy minimum element requirements |
| [FDA Medical Device]({{ site.url }}/compliance/fda-medical-device/)               | SPDX and CycloneDX both referenced in FDA guidance         |
| [NIST SP 800-53]({{ site.url }}/compliance/nist-800-53/)                          | Format-agnostic; focuses on controls, not format           |
| [NIST SP 800-171]({{ site.url }}/compliance/nist-800-171/)                        | Format-agnostic; focuses on CUI protection requirements    |
