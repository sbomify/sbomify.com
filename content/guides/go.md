...
For Go, sbomify uses **cyclonedx-gomod** under the hood, which reads the module graph the Go toolchain itself resolved.
...
For more SBOM tools and resources, see our [SBOM Resources](/resources/) page, which includes additional Go-specific tools like CycloneDX Go and SPDX Golang libraries.
