...
- **Produce an SBOM** identifying components and dependencies in their products
...
The SBOM must cover at minimum the top-level dependencies of the product. The exact depth requirements are being further specified through harmonized standards.
...
- Open-source projects distributed commercially (though non-commercial open source has exemptions)
...
- Generate and manage SBOMs across your product portfolio
- Track vulnerability status with automated monitoring
- Share compliance artifacts through your [Trust Center](https://trust.sbomify.com/)
- CRA assessment plugin to evaluate your readiness
