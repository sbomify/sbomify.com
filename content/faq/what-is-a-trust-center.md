...
sbomify includes a built-in Trust Center that automatically publishes your uploaded SBOMs and compliance artifacts. You can see a live example at [trust.sbomify.com](https://trust.sbomify.com/) — that's sbomify's own Trust Center, built with the same feature available to all users.

Key features:

- **Automatic updates** — When you upload a new SBOM, your Trust Center reflects it immediately
- **Custom branding** — Use your own domain and styling
- **Granular access** — Choose which artifacts are public vs. private
- **Compliance badges** — Show which standards your products meet

## Getting started

1. [Sign up for sbomify](https://app.sbomify.com) (free Community tier available)
2. Upload your SBOM
3. Configure your Trust Center settings
4. Share the URL with customers

No additional setup or hosting is required — sbomify handles everything.
