...
The [Transparency Exchange API (TEA)](https://www.ietf.org/archive/id/draft-ietf-opsawg-sbom-access-08.html) is an emerging standard for automated SBOM discovery and distribution. It allows consumers of your software to programmatically find and retrieve your SBOMs without manual exchange.
