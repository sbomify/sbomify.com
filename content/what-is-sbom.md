...
- **United States:** [Executive Order 14028](/compliance/eo-14028/), [FDA medical device guidance](/compliance/fda-medical-device/), and [CISA minimum elements](/compliance/cisa-minimum-elements/)
- **European Union:** [Cyber Resilience Act (CRA)](/compliance/eu-cra/) and [NIS2 Directive](/compliance/eu-nis2/)
- **United Kingdom:** [Software Security Code of Practice](/compliance/uk-software-security-code-of-practice/) (voluntary guidance for software vendors)
- **Industry Standards:** [PCI DSS 4.0](/compliance/pci-dss/) for payment card security

For a comprehensive breakdown of all compliance frameworks, requirements, and field mappings, see our **[SBOM Compliance Guide](/compliance/)**.
...
SBOMs are no longer optional; they are becoming a global standard for software transparency, security, and compliance. With regulations now in effect across the US and EU, the ability to generate and manage SBOMs is essential for modern software organizations. See our [SBOM Compliance Guide](/compliance/) for detailed requirements by framework.
...
The two industry-standard SBOM formats are [CycloneDX](https://cyclonedx.org/) (developed by OWASP) and [SPDX](https://spdx.dev/) (developed by the Linux Foundation). Both are widely accepted by compliance frameworks. See our [SBOM formats comparison](/2026/01/15/sbom-formats-cyclonedx-vs-spdx/) for a detailed guide.
