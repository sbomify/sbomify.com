...
Organisations already generating SBOMs for other compliance requirements (e.g., [EU CRA](/compliance/eu-cra/), [NTIA minimum elements](/compliance/ntia-minimum-elements/)) will find they are well-positioned to meet the Code's expectations.

---

## Related Frameworks

- [EU Cyber Resilience Act (CRA)](/compliance/eu-cra/) - Binding EU law with SBOM requirements
