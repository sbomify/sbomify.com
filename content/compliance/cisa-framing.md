...
The Framing document defines baseline attributes that should be present in every SBOM. These align closely with the [NTIA minimum elements](/compliance/ntia-minimum-elements/) but provide additional context and cross-format mappings.

## Why This Document Matters

The Framing document is particularly useful as:

1. **The canonical source for schema field mappings** - See our [Schema Crosswalk](/compliance/schema-crosswalk/)
