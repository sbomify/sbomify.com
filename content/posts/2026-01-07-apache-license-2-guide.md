...
Unlike copyleft licenses such as the [GPL](/2025/12/22/gpl-license-guide/), the Apache License 2.0 does **not** require:
...
A [Software Bill of Materials](/what-is-sbom/) documents every component in your software along with its license. For Apache-licensed components, SBOMs support compliance in several ways:
