...
For detailed instructions on generating separate SBOMs from container images, see our [Docker SBOM guide](/guides/docker/). For a broader overview of SBOM tools, see our [resources page](/resources/).
...
3. **Generate separate SBOMs per layer.** Generate an application SBOM from your lock file and a container SBOM from the built image. Organize both under a single product in your [SBOM management platform](/2026/01/18/sbom-management-best-practices/) for continuous vulnerability monitoring.
