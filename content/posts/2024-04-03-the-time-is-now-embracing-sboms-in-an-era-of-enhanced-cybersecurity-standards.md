...
faq:
  ...
  - question: "What SBOM tools are available today?"
    answer: "The ecosystem is mature. GitHub natively generates SBOMs via Dependency Graph. Docker Scout provides container SBOMs. Open source generators include the sbomify GitHub Action, Syft, ~~Trivy~~ (compromised March 2026, see /2026/03/26/trivy-compromise-hardening-sbomify-action/), and CycloneDX plugins. Management platforms include sbomify (with vulnerability monitoring via Google OSV) and OWASP Dependency-Track. Most organizations can go from zero to continuous SBOM monitoring in a single sprint."
date: 2024-04-03
